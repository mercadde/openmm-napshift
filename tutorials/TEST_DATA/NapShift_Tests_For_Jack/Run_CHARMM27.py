...
gro = app.GromacsGroFile(args.grofile)
gromacs_top = app.GromacsTopFile(args.topfile, periodicBoxVectors=gro.getPeriodicBoxVectors(),
...
if args.use_NapShift:
    napshift_force = get_napshift_force(top, args.CS_file, model_type='all_atom')
